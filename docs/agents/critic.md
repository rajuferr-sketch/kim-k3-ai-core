...
**Pipeline position:** 10 of 15 &middot; **Manifest:** [`agents/critic.yaml`](../../agents/critic.yaml) &middot; **Implementation:** [`src/kim_k3/agents/critic_agent.py`](../../src/kim_k3/agents/critic_agent.py)
...
- Critique: findings[] with severity, location, suggested fix
...
result = await CriticAgent().run(AgentContext(request=request, blackboard=blackboard))
