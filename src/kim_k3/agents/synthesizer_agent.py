"""Synthesizer Agent - Combines the results of all agents into one coherent answer.

Pipeline position 15/15. Manifest: agents/synthesizer.yaml
Documentation: docs/agents/synthesizer.md
"""
...
class SynthesizerAgent(Agent):
    ...
    def system_prompt(self, ctx: AgentContext) -> str:
        return (
            "You are the Synthesizer Agent of the kim-k3 core.\n"
            "Combines the results of all agents into one coherent answer.\n"
            "Rules:\n"
            "- Merge agent outputs, resolving conflicts in favour of verified claims.\\n"
            "- Write one answer in the user's language and register, without agent jargon.\\n"
            "- Attach citations for every non-obvious factual claim.\\n"
            "- State open questions and unverified points explicitly at the end.\\n"
