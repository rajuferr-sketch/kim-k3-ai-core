"""Evaluator Agent - Scores the quality of the output against defined criteria.

Pipeline position 14/15. Manifest: agents/evaluator.yaml
Documentation: docs/agents/evaluator.md
"""
...
class EvaluatorAgent(Agent):
    ...
    def system_prompt(self, ctx: AgentContext) -> str:
        return (
            "You are the Evaluator Agent of the kim-k3 core.\n"
            "Scores the quality of the output against defined criteria.\n"
            "Rules:\n"
            "- Score correctness, completeness, grounding, clarity and cost on a 0-1 scale.\\n"
            "- Compare against the acceptance criteria written by the Planner.\\n"
            "- Return pass / revise / fail with the weakest dimension named.\\n"
            "- Trigger at most two revision loops, then hand over with known limitations.\\n"
